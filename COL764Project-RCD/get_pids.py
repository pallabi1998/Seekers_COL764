        ...
        for line in file:
            ...
            if in_p_tag:
                ...
                if "</p>" in line:
                    ...
                    #     with open(f"pid_{LCNT}.pkl", "wb") as f:
                    #         pickle.dump(passages_no, f)
                    #     del passages_no
                    #     del passages_text
                    #     passages_text = []
                    #     passages_no = []
...
passages_no, passages_text = find_titles_in_file(wiki_path, max_titles=math.inf, start=0)
with open(f"pid_last.pkl", "wb") as f:
    pickle.dump(passages_no, f)
print("loaded")
